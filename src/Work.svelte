<script>
  ...
  const projects = [
    ...
    },
    {
      id: 1,
      title: "Marci Forms",
      gif: "/MarciForms/marci-forms.webp",
      demoLogin: [
        {
          id: "Email",
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: "View Code",
          href: "https://github.com/Nukambe/moriahyoung-react-app",
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: "View Code",
          href: "https://github.com/Nukambe/samiyah",
          color: "text-slate-500 hover:text-slate-800",
        },
      ],
      tags: [
